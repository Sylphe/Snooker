const CACHE_VERSION = "5.7.75C-semantic-completeness-scoring-v2";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.75C",
  "./styles.css?v=5.7.75C",
  "./app.js?v=5.7.75C",
  "./early-theme.js?v=5.7.75C",
  "./modules/app-core.js?v=5.7.75C",
  "./modules/version.js?v=5.7.75C",
  "./modules/store.js?v=5.7.75C",
  "./modules/utils.js?v=5.7.75C",
  "./modules/settings.js?v=5.7.75C",
  "./modules/analytics.js?v=5.7.75C",
  "./modules/bayesian.js?v=5.7.75C",
  "./modules/session.js?v=5.7.75C",
  "./modules/pressure.js?v=5.7.75C",
  "./modules/recommendations.js?v=5.7.75C",
  "./modules/render.js?v=5.7.75C",
  "./modules/inference.js?v=5.7.75C",
  "./manifest.json?v=5.7.75C",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.75C",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.75C",
  "./icon.svg?v=5.7.75C"
];
