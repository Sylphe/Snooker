const CACHE_VERSION = "5.7.76H-focus-inspector-system";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.76H",
  "./styles.css?v=5.7.76H",
  "./app.js?v=5.7.76H",
  "./early-theme.js?v=5.7.76H",
  "./modules/app-core.js?v=5.7.76H",
  "./modules/version.js?v=5.7.76H",
  "./modules/store.js?v=5.7.76H",
  "./modules/utils.js?v=5.7.76H",
  "./modules/settings.js?v=5.7.76H",
  "./modules/analytics.js?v=5.7.76H",
  "./modules/bayesian.js?v=5.7.76H",
  "./modules/session.js?v=5.7.76H",
  "./modules/pressure.js?v=5.7.76H",
  "./modules/recommendations.js?v=5.7.76H",
  "./modules/render.js?v=5.7.76H",
  "./modules/inference.js?v=5.7.76H",
  "./manifest.json?v=5.7.76H",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.76H",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.76H",
  "./icon.svg?v=5.7.76H"
];
