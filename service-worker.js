const CACHE_VERSION = "5.9.15-smart-builder-render-helper-hotfix";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.9.15",
  "./styles.css?v=5.9.15",
  "./app.js?v=5.9.15",
  "./early-theme.js?v=5.9.15",
  "./modules/app-core.js?v=5.9.15",
  "./modules/version.js?v=5.9.15",
  "./modules/store.js?v=5.9.15",
  "./modules/utils.js?v=5.9.15",
  "./modules/settings.js?v=5.9.15",
  "./modules/analytics.js?v=5.9.15",
  "./modules/bayesian.js?v=5.9.15",
  "./modules/session.js?v=5.9.15",
  "./modules/pressure.js?v=5.9.15",
  "./modules/recommendations.js?v=5.9.15",
  "./modules/render.js?v=5.9.15",
  "./modules/inference.js?v=5.9.15",
  "./manifest.json?v=5.9.15",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.9.15",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.9.15",
  "./icon.svg?v=5.9.15"
];
