const CACHE_VERSION = "5.7.22-legacy-routine-upgrade-layer";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.22",
  "./styles.css?v=5.7.22",
  "./app.js?v=5.7.22",
  "./early-theme.js?v=5.7.22",
  "./modules/app-core.js?v=5.7.22",
  "./modules/version.js?v=5.7.22",
  "./modules/store.js?v=5.7.22",
  "./modules/utils.js?v=5.7.22",
  "./modules/settings.js?v=5.7.22",
  "./modules/analytics.js?v=5.7.22",
  "./modules/bayesian.js?v=5.7.22",
  "./modules/session.js?v=5.7.22",
  "./modules/pressure.js?v=5.7.22",
  "./modules/recommendations.js?v=5.7.22",
  "./modules/render.js?v=5.7.22",
  "./modules/inference.js?v=5.7.22",
  "./manifest.json?v=5.7.22",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.22",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.22",
  "./icon.svg?v=5.7.22"
];
