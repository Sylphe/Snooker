const CACHE_VERSION = "5.7.67.7-progressive-disclosure-ux-pass";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.67.7",
  "./styles.css?v=5.7.67.7",
  "./app.js?v=5.7.67.7",
  "./early-theme.js?v=5.7.67.7",
  "./modules/app-core.js?v=5.7.67.7",
  "./modules/version.js?v=5.7.67.7",
  "./modules/store.js?v=5.7.67.7",
  "./modules/utils.js?v=5.7.67.7",
  "./modules/settings.js?v=5.7.67.7",
  "./modules/analytics.js?v=5.7.67.7",
  "./modules/bayesian.js?v=5.7.67.7",
  "./modules/session.js?v=5.7.67.7",
  "./modules/pressure.js?v=5.7.67.7",
  "./modules/recommendations.js?v=5.7.67.7",
  "./modules/render.js?v=5.7.67.7",
  "./modules/inference.js?v=5.7.67.7",
  "./manifest.json?v=5.7.67.7",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.67.7",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.67.7",
  "./icon.svg?v=5.7.67.7"
];
