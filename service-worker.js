const CACHE_VERSION = "5.7.40-stats-dashboard-redesign";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.40",
  "./styles.css?v=5.7.40",
  "./app.js?v=5.7.40",
  "./early-theme.js?v=5.7.40",
  "./modules/app-core.js?v=5.7.40",
  "./modules/version.js?v=5.7.40",
  "./modules/store.js?v=5.7.40",
  "./modules/utils.js?v=5.7.40",
  "./modules/settings.js?v=5.7.40",
  "./modules/analytics.js?v=5.7.40",
  "./modules/bayesian.js?v=5.7.40",
  "./modules/session.js?v=5.7.40",
  "./modules/pressure.js?v=5.7.40",
  "./modules/recommendations.js?v=5.7.40",
  "./modules/render.js?v=5.7.40",
  "./modules/inference.js?v=5.7.40",
  "./manifest.json?v=5.7.40",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.40",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.40",
  "./icon.svg?v=5.7.40"
];
