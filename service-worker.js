const CACHE_VERSION = "5.7.39-stats-coaching-subtab";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.39",
  "./styles.css?v=5.7.39",
  "./app.js?v=5.7.39",
  "./early-theme.js?v=5.7.39",
  "./modules/app-core.js?v=5.7.39",
  "./modules/version.js?v=5.7.39",
  "./modules/store.js?v=5.7.39",
  "./modules/utils.js?v=5.7.39",
  "./modules/settings.js?v=5.7.39",
  "./modules/analytics.js?v=5.7.39",
  "./modules/bayesian.js?v=5.7.39",
  "./modules/session.js?v=5.7.39",
  "./modules/pressure.js?v=5.7.39",
  "./modules/recommendations.js?v=5.7.39",
  "./modules/render.js?v=5.7.39",
  "./modules/inference.js?v=5.7.39",
  "./manifest.json?v=5.7.39",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.39",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.39",
  "./icon.svg?v=5.7.39"
];
