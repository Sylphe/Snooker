const CACHE_VERSION = "5.7.75D-spreadsheet-ux-density-pass";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.75D",
  "./styles.css?v=5.7.75D",
  "./app.js?v=5.7.75D",
  "./early-theme.js?v=5.7.75D",
  "./modules/app-core.js?v=5.7.75D",
  "./modules/version.js?v=5.7.75D",
  "./modules/store.js?v=5.7.75D",
  "./modules/utils.js?v=5.7.75D",
  "./modules/settings.js?v=5.7.75D",
  "./modules/analytics.js?v=5.7.75D",
  "./modules/bayesian.js?v=5.7.75D",
  "./modules/session.js?v=5.7.75D",
  "./modules/pressure.js?v=5.7.75D",
  "./modules/recommendations.js?v=5.7.75D",
  "./modules/render.js?v=5.7.75D",
  "./modules/inference.js?v=5.7.75D",
  "./manifest.json?v=5.7.75D",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.75D",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.75D",
  "./icon.svg?v=5.7.75D"
];
