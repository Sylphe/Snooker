const CACHE_VERSION = "5.7.74C-routine-console-validation-dashboard";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.74C",
  "./styles.css?v=5.7.74C",
  "./app.js?v=5.7.74C",
  "./early-theme.js?v=5.7.74C",
  "./modules/app-core.js?v=5.7.74C",
  "./modules/version.js?v=5.7.74C",
  "./modules/store.js?v=5.7.74C",
  "./modules/utils.js?v=5.7.74C",
  "./modules/settings.js?v=5.7.74C",
  "./modules/analytics.js?v=5.7.74C",
  "./modules/bayesian.js?v=5.7.74C",
  "./modules/session.js?v=5.7.74C",
  "./modules/pressure.js?v=5.7.74C",
  "./modules/recommendations.js?v=5.7.74C",
  "./modules/render.js?v=5.7.74C",
  "./modules/inference.js?v=5.7.74C",
  "./manifest.json?v=5.7.74C",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.74C",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.74C",
  "./icon.svg?v=5.7.74C"
];
