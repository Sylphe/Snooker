const CACHE_NAME = "snooker-practice-log-v4-27-0-smart-session-builder-v2";
const ASSETS = [
  "./index.html?v=4.27.0",
  "./styles.css?v=4.27.0",
  "./app.js?v=4.27.0",
  "./modules/app-core.js?v=4.27.0",
  "./modules/version.js?v=4.27.0",
  "./modules/store.js?v=4.27.0",
  "./modules/utils.js?v=4.27.0",
  "./modules/settings.js?v=4.27.0",
  "./modules/analytics.js?v=4.27.0",
  "./modules/bayesian.js?v=4.27.0",
  "./modules/session.js?v=4.27.0",
  "./modules/pressure.js?v=4.27.0",
  "./modules/recommendations.js?v=4.27.0",
  "./modules/render.js?v=4.27.0",
  "./manifest.json?v=4.27.0",
  "./icon.svg?v=4.27.0"
];
