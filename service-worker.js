const CACHE_VERSION = "5.7.57-etu-history-load-management";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.57",
  "./styles.css?v=5.7.57",
  "./app.js?v=5.7.57",
  "./early-theme.js?v=5.7.57",
  "./modules/app-core.js?v=5.7.57",
  "./modules/version.js?v=5.7.57",
  "./modules/store.js?v=5.7.57",
  "./modules/utils.js?v=5.7.57",
  "./modules/settings.js?v=5.7.57",
  "./modules/analytics.js?v=5.7.57",
  "./modules/bayesian.js?v=5.7.57",
  "./modules/session.js?v=5.7.57",
  "./modules/pressure.js?v=5.7.57",
  "./modules/recommendations.js?v=5.7.57",
  "./modules/render.js?v=5.7.57",
  "./modules/inference.js?v=5.7.57",
  "./manifest.json?v=5.7.57",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.57",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.57",
  "./icon.svg?v=5.7.57"
];
