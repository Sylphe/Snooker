const CACHE_VERSION = "5.9.5-training-rotation-layer";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.9.5",
  "./styles.css?v=5.9.5",
  "./app.js?v=5.9.5",
  "./early-theme.js?v=5.9.5",
  "./modules/app-core.js?v=5.9.5",
  "./modules/version.js?v=5.9.5",
  "./modules/store.js?v=5.9.5",
  "./modules/utils.js?v=5.9.5",
  "./modules/settings.js?v=5.9.5",
  "./modules/analytics.js?v=5.9.5",
  "./modules/bayesian.js?v=5.9.5",
  "./modules/session.js?v=5.9.5",
  "./modules/pressure.js?v=5.9.5",
  "./modules/recommendations.js?v=5.9.5",
  "./modules/render.js?v=5.9.5",
  "./modules/inference.js?v=5.9.5",
  "./manifest.json?v=5.9.5",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.9.5",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.9.5",
  "./icon.svg?v=5.9.5"
];
