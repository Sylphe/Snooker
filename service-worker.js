const CACHE_VERSION = "5.9.14-smart-builder-runtime-integrity-fix";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.9.14",
  "./styles.css?v=5.9.14",
  "./app.js?v=5.9.14",
  "./early-theme.js?v=5.9.14",
  "./modules/app-core.js?v=5.9.14",
  "./modules/version.js?v=5.9.14",
  "./modules/store.js?v=5.9.14",
  "./modules/utils.js?v=5.9.14",
  "./modules/settings.js?v=5.9.14",
  "./modules/analytics.js?v=5.9.14",
  "./modules/bayesian.js?v=5.9.14",
  "./modules/session.js?v=5.9.14",
  "./modules/pressure.js?v=5.9.14",
  "./modules/recommendations.js?v=5.9.14",
  "./modules/render.js?v=5.9.14",
  "./modules/inference.js?v=5.9.14",
  "./manifest.json?v=5.9.14",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.9.14",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.9.14",
  "./icon.svg?v=5.9.14"
];
