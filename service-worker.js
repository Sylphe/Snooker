const CACHE_VERSION = "5.7.55-prediction-bootstrap-version-fix";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.55",
  "./styles.css?v=5.7.55",
  "./app.js?v=5.7.55",
  "./early-theme.js?v=5.7.55",
  "./modules/app-core.js?v=5.7.55",
  "./modules/version.js?v=5.7.55",
  "./modules/store.js?v=5.7.55",
  "./modules/utils.js?v=5.7.55",
  "./modules/settings.js?v=5.7.55",
  "./modules/analytics.js?v=5.7.55",
  "./modules/bayesian.js?v=5.7.55",
  "./modules/session.js?v=5.7.55",
  "./modules/pressure.js?v=5.7.55",
  "./modules/recommendations.js?v=5.7.55",
  "./modules/render.js?v=5.7.55",
  "./modules/inference.js?v=5.7.55",
  "./manifest.json?v=5.7.55",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.55",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.55",
  "./icon.svg?v=5.7.55"
];
