const CACHE_VERSION = "5.7.77U-focus-mode-v2-stabilization-pass";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.77U",
  "./styles.css?v=5.7.77U",
  "./app.js?v=5.7.77U",
  "./early-theme.js?v=5.7.77U",
  "./modules/app-core.js?v=5.7.77U",
  "./modules/version.js?v=5.7.77U",
  "./modules/store.js?v=5.7.77U",
  "./modules/utils.js?v=5.7.77U",
  "./modules/settings.js?v=5.7.77U",
  "./modules/analytics.js?v=5.7.77U",
  "./modules/bayesian.js?v=5.7.77U",
  "./modules/session.js?v=5.7.77U",
  "./modules/pressure.js?v=5.7.77U",
  "./modules/recommendations.js?v=5.7.77U",
  "./modules/render.js?v=5.7.77U",
  "./modules/inference.js?v=5.7.77U",
  "./manifest.json?v=5.7.77U",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.77U",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.77U",
  "./icon.svg?v=5.7.77U"
];
