const CACHE_VERSION = "5.6.20-selective-library-import";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.6.20",
  "./styles.css?v=5.6.20",
  "./app.js?v=5.6.20",
  "./early-theme.js?v=5.6.20",
  "./modules/app-core.js?v=5.6.20",
  "./modules/version.js?v=5.6.20",
  "./modules/store.js?v=5.6.20",
  "./modules/utils.js?v=5.6.20",
  "./modules/settings.js?v=5.6.20",
  "./modules/analytics.js?v=5.6.20",
  "./modules/bayesian.js?v=5.6.20",
  "./modules/session.js?v=5.6.20",
  "./modules/pressure.js?v=5.6.20",
  "./modules/recommendations.js?v=5.6.20",
  "./modules/render.js?v=5.6.20",
  "./modules/inference.js?v=5.6.20",
  "./manifest.json?v=5.6.20",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.6.20",
  "./icon.svg?v=5.6.20"
];
