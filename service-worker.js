const CACHE_VERSION = "5.6.16-cross-routine-skill-graph";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.6.16",
  "./styles.css?v=5.6.16",
  "./app.js?v=5.6.16",
  "./early-theme.js?v=5.6.16",
  "./modules/app-core.js?v=5.6.16",
  "./modules/version.js?v=5.6.16",
  "./modules/store.js?v=5.6.16",
  "./modules/utils.js?v=5.6.16",
  "./modules/settings.js?v=5.6.16",
  "./modules/analytics.js?v=5.6.16",
  "./modules/bayesian.js?v=5.6.16",
  "./modules/session.js?v=5.6.16",
  "./modules/pressure.js?v=5.6.16",
  "./modules/recommendations.js?v=5.6.16",
  "./modules/render.js?v=5.6.16",
  "./modules/inference.js?v=5.6.16",
  "./manifest.json?v=5.6.16",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.6.16",
  "./icon.svg?v=5.6.16"
];
