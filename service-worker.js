const CACHE_VERSION = "5.7.28-smart-session-button-binding-fix";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.28",
  "./styles.css?v=5.7.28",
  "./app.js?v=5.7.28",
  "./early-theme.js?v=5.7.28",
  "./modules/app-core.js?v=5.7.28",
  "./modules/version.js?v=5.7.28",
  "./modules/store.js?v=5.7.28",
  "./modules/utils.js?v=5.7.28",
  "./modules/settings.js?v=5.7.28",
  "./modules/analytics.js?v=5.7.28",
  "./modules/bayesian.js?v=5.7.28",
  "./modules/session.js?v=5.7.28",
  "./modules/pressure.js?v=5.7.28",
  "./modules/recommendations.js?v=5.7.28",
  "./modules/render.js?v=5.7.28",
  "./modules/inference.js?v=5.7.28",
  "./manifest.json?v=5.7.28",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.28",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.28",
  "./icon.svg?v=5.7.28"
];
