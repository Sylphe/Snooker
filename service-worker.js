const CACHE_VERSION = "5.6.12-dynamic-routine-difficulty-model";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.6.12",
  "./styles.css?v=5.6.12",
  "./app.js?v=5.6.12",
  "./early-theme.js?v=5.6.12",
  "./modules/app-core.js?v=5.6.12",
  "./modules/version.js?v=5.6.12",
  "./modules/store.js?v=5.6.12",
  "./modules/utils.js?v=5.6.12",
  "./modules/settings.js?v=5.6.12",
  "./modules/analytics.js?v=5.6.12",
  "./modules/bayesian.js?v=5.6.12",
  "./modules/session.js?v=5.6.12",
  "./modules/pressure.js?v=5.6.12",
  "./modules/recommendations.js?v=5.6.12",
  "./modules/render.js?v=5.6.12",
  "./modules/inference.js?v=5.6.12",
  "./manifest.json?v=5.6.12",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.6.12",
  "./icon.svg?v=5.6.12"
];
