const CACHE_VERSION = "5.7.3-focus-mode-layout-correction";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.3",
  "./styles.css?v=5.7.3",
  "./app.js?v=5.7.3",
  "./early-theme.js?v=5.7.3",
  "./modules/app-core.js?v=5.7.3",
  "./modules/version.js?v=5.7.3",
  "./modules/store.js?v=5.7.3",
  "./modules/utils.js?v=5.7.3",
  "./modules/settings.js?v=5.7.3",
  "./modules/analytics.js?v=5.7.3",
  "./modules/bayesian.js?v=5.7.3",
  "./modules/session.js?v=5.7.3",
  "./modules/pressure.js?v=5.7.3",
  "./modules/recommendations.js?v=5.7.3",
  "./modules/render.js?v=5.7.3",
  "./modules/inference.js?v=5.7.3",
  "./manifest.json?v=5.7.3",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.3",
  "./icon.svg?v=5.7.3"
];
