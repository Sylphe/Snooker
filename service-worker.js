const CACHE_VERSION = "5.7.77H-focus-mode-v2-minimal-visual-language-pass";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.77H",
  "./styles.css?v=5.7.77H",
  "./app.js?v=5.7.77H",
  "./early-theme.js?v=5.7.77H",
  "./modules/app-core.js?v=5.7.77H",
  "./modules/version.js?v=5.7.77H",
  "./modules/store.js?v=5.7.77H",
  "./modules/utils.js?v=5.7.77H",
  "./modules/settings.js?v=5.7.77H",
  "./modules/analytics.js?v=5.7.77H",
  "./modules/bayesian.js?v=5.7.77H",
  "./modules/session.js?v=5.7.77H",
  "./modules/pressure.js?v=5.7.77H",
  "./modules/recommendations.js?v=5.7.77H",
  "./modules/render.js?v=5.7.77H",
  "./modules/inference.js?v=5.7.77H",
  "./manifest.json?v=5.7.77H",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.77H",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.77H",
  "./icon.svg?v=5.7.77H"
];
