const CACHE_VERSION = "5.7.75F-knowledge-graph-integrity-engine";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.75F",
  "./styles.css?v=5.7.75F",
  "./app.js?v=5.7.75F",
  "./early-theme.js?v=5.7.75F",
  "./modules/app-core.js?v=5.7.75F",
  "./modules/version.js?v=5.7.75F",
  "./modules/store.js?v=5.7.75F",
  "./modules/utils.js?v=5.7.75F",
  "./modules/settings.js?v=5.7.75F",
  "./modules/analytics.js?v=5.7.75F",
  "./modules/bayesian.js?v=5.7.75F",
  "./modules/session.js?v=5.7.75F",
  "./modules/pressure.js?v=5.7.75F",
  "./modules/recommendations.js?v=5.7.75F",
  "./modules/render.js?v=5.7.75F",
  "./modules/inference.js?v=5.7.75F",
  "./manifest.json?v=5.7.75F",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.75F",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.75F",
  "./icon.svg?v=5.7.75F"
];
