const CACHE_VERSION = "5.7.36-focus-common-band-live-fix";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.36",
  "./styles.css?v=5.7.36",
  "./app.js?v=5.7.36",
  "./early-theme.js?v=5.7.36",
  "./modules/app-core.js?v=5.7.36",
  "./modules/version.js?v=5.7.36",
  "./modules/store.js?v=5.7.36",
  "./modules/utils.js?v=5.7.36",
  "./modules/settings.js?v=5.7.36",
  "./modules/analytics.js?v=5.7.36",
  "./modules/bayesian.js?v=5.7.36",
  "./modules/session.js?v=5.7.36",
  "./modules/pressure.js?v=5.7.36",
  "./modules/recommendations.js?v=5.7.36",
  "./modules/render.js?v=5.7.36",
  "./modules/inference.js?v=5.7.36",
  "./manifest.json?v=5.7.36",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.36",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.36",
  "./icon.svg?v=5.7.36"
];
