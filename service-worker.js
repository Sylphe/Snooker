const CACHE_VERSION = "5.7.54-prediction-visuals-etu-benchmark-path";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.54",
  "./styles.css?v=5.7.54",
  "./app.js?v=5.7.54",
  "./early-theme.js?v=5.7.54",
  "./modules/app-core.js?v=5.7.54",
  "./modules/version.js?v=5.7.54",
  "./modules/store.js?v=5.7.54",
  "./modules/utils.js?v=5.7.54",
  "./modules/settings.js?v=5.7.54",
  "./modules/analytics.js?v=5.7.54",
  "./modules/bayesian.js?v=5.7.54",
  "./modules/session.js?v=5.7.54",
  "./modules/pressure.js?v=5.7.54",
  "./modules/recommendations.js?v=5.7.54",
  "./modules/render.js?v=5.7.54",
  "./modules/inference.js?v=5.7.54",
  "./manifest.json?v=5.7.54",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.54",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.54",
  "./icon.svg?v=5.7.54"
];
