const CACHE_VERSION = "5.7.75G-semantic-chip-system";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.75G",
  "./styles.css?v=5.7.75G",
  "./app.js?v=5.7.75G",
  "./early-theme.js?v=5.7.75G",
  "./modules/app-core.js?v=5.7.75G",
  "./modules/version.js?v=5.7.75G",
  "./modules/store.js?v=5.7.75G",
  "./modules/utils.js?v=5.7.75G",
  "./modules/settings.js?v=5.7.75G",
  "./modules/analytics.js?v=5.7.75G",
  "./modules/bayesian.js?v=5.7.75G",
  "./modules/session.js?v=5.7.75G",
  "./modules/pressure.js?v=5.7.75G",
  "./modules/recommendations.js?v=5.7.75G",
  "./modules/render.js?v=5.7.75G",
  "./modules/inference.js?v=5.7.75G",
  "./manifest.json?v=5.7.75G",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.75G",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.75G",
  "./icon.svg?v=5.7.75G"
];
