const CACHE_VERSION = "5.7.74G-routine-archetype-framework";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.74G",
  "./styles.css?v=5.7.74G",
  "./app.js?v=5.7.74G",
  "./early-theme.js?v=5.7.74G",
  "./modules/app-core.js?v=5.7.74G",
  "./modules/version.js?v=5.7.74G",
  "./modules/store.js?v=5.7.74G",
  "./modules/utils.js?v=5.7.74G",
  "./modules/settings.js?v=5.7.74G",
  "./modules/analytics.js?v=5.7.74G",
  "./modules/bayesian.js?v=5.7.74G",
  "./modules/session.js?v=5.7.74G",
  "./modules/pressure.js?v=5.7.74G",
  "./modules/recommendations.js?v=5.7.74G",
  "./modules/render.js?v=5.7.74G",
  "./modules/inference.js?v=5.7.74G",
  "./manifest.json?v=5.7.74G",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.74G",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.74G",
  "./icon.svg?v=5.7.74G"
];
