const CACHE_VERSION = "5.7.74D-spreadsheet-grid-engine";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.74D",
  "./styles.css?v=5.7.74D",
  "./app.js?v=5.7.74D",
  "./early-theme.js?v=5.7.74D",
  "./modules/app-core.js?v=5.7.74D",
  "./modules/version.js?v=5.7.74D",
  "./modules/store.js?v=5.7.74D",
  "./modules/utils.js?v=5.7.74D",
  "./modules/settings.js?v=5.7.74D",
  "./modules/analytics.js?v=5.7.74D",
  "./modules/bayesian.js?v=5.7.74D",
  "./modules/session.js?v=5.7.74D",
  "./modules/pressure.js?v=5.7.74D",
  "./modules/recommendations.js?v=5.7.74D",
  "./modules/render.js?v=5.7.74D",
  "./modules/inference.js?v=5.7.74D",
  "./manifest.json?v=5.7.74D",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.74D",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.74D",
  "./icon.svg?v=5.7.74D"
];
