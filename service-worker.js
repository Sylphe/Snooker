const CACHE_VERSION = "5.7.77S-focus-mode-v2-semantic-ball-controls-auto-save-feedback-overlay";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.77S",
  "./styles.css?v=5.7.77S",
  "./app.js?v=5.7.77S",
  "./early-theme.js?v=5.7.77S",
  "./modules/app-core.js?v=5.7.77S",
  "./modules/version.js?v=5.7.77S",
  "./modules/store.js?v=5.7.77S",
  "./modules/utils.js?v=5.7.77S",
  "./modules/settings.js?v=5.7.77S",
  "./modules/analytics.js?v=5.7.77S",
  "./modules/bayesian.js?v=5.7.77S",
  "./modules/session.js?v=5.7.77S",
  "./modules/pressure.js?v=5.7.77S",
  "./modules/recommendations.js?v=5.7.77S",
  "./modules/render.js?v=5.7.77S",
  "./modules/inference.js?v=5.7.77S",
  "./manifest.json?v=5.7.77S",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.77S",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.77S",
  "./icon.svg?v=5.7.77S"
];
