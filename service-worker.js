const CACHE_VERSION = "5.7.0-focus-mode-ux-reset";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.0",
  "./styles.css?v=5.7.0",
  "./app.js?v=5.7.0",
  "./early-theme.js?v=5.7.0",
  "./modules/app-core.js?v=5.7.0",
  "./modules/version.js?v=5.7.0",
  "./modules/store.js?v=5.7.0",
  "./modules/utils.js?v=5.7.0",
  "./modules/settings.js?v=5.7.0",
  "./modules/analytics.js?v=5.7.0",
  "./modules/bayesian.js?v=5.7.0",
  "./modules/session.js?v=5.7.0",
  "./modules/pressure.js?v=5.7.0",
  "./modules/recommendations.js?v=5.7.0",
  "./modules/render.js?v=5.7.0",
  "./modules/inference.js?v=5.7.0",
  "./manifest.json?v=5.7.0",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.0",
  "./icon.svg?v=5.7.0"
];
