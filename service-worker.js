const CACHE_VERSION = "5.7.47-prediction-engine-bootstrap-safe";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.47",
  "./styles.css?v=5.7.47",
  "./app.js?v=5.7.47",
  "./early-theme.js?v=5.7.47",
  "./modules/app-core.js?v=5.7.47",
  "./modules/version.js?v=5.7.47",
  "./modules/store.js?v=5.7.47",
  "./modules/utils.js?v=5.7.47",
  "./modules/settings.js?v=5.7.47",
  "./modules/analytics.js?v=5.7.47",
  "./modules/bayesian.js?v=5.7.47",
  "./modules/session.js?v=5.7.47",
  "./modules/pressure.js?v=5.7.47",
  "./modules/recommendations.js?v=5.7.47",
  "./modules/render.js?v=5.7.47",
  "./modules/inference.js?v=5.7.47",
  "./manifest.json?v=5.7.47",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.47",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.47",
  "./icon.svg?v=5.7.47"
];
