const CACHE_VERSION = "5.5.23-lightweight-core-serialization";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.5.23",
  "./styles.css?v=5.5.23",
  "./app.js?v=5.5.23",
  "./early-theme.js?v=5.5.23",
  "./modules/app-core.js?v=5.5.23",
  "./modules/version.js?v=5.5.23",
  "./modules/store.js?v=5.5.23",
  "./modules/utils.js?v=5.5.23",
  "./modules/settings.js?v=5.5.23",
  "./modules/analytics.js?v=5.5.23",
  "./modules/bayesian.js?v=5.5.23",
  "./modules/session.js?v=5.5.23",
  "./modules/pressure.js?v=5.5.23",
  "./modules/recommendations.js?v=5.5.23",
  "./modules/render.js?v=5.5.23",
  "./modules/inference.js?v=5.5.23",
  "./manifest.json?v=5.5.23",
  "./icon.svg?v=5.5.23"
];
