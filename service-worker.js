const CACHE_NAME = "snooker-practice-log-v4-26-3-skill-tag-history-sync";
const ASSETS = [
  "./index.html?v=4.26.3",
  "./styles.css?v=4.26.3",
  "./app.js?v=4.26.3",
  "./modules/app-core.js?v=4.26.3",
  "./modules/version.js?v=4.26.3",
  "./modules/store.js?v=4.26.3",
  "./modules/utils.js?v=4.26.3",
  "./modules/settings.js?v=4.26.3",
  "./modules/analytics.js?v=4.26.3",
  "./modules/bayesian.js?v=4.26.3",
  "./modules/session.js?v=4.26.3",
  "./modules/pressure.js?v=4.26.3",
  "./modules/recommendations.js?v=4.26.3",
  "./modules/render.js?v=4.26.3",
  "./manifest.json?v=4.26.3",
  "./icon.svg?v=4.26.3"
];
