const CACHE_VERSION = "5.5.9-storage-timer-hardening";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.5.9",
  "./styles.css?v=5.5.9",
  "./app.js?v=5.5.9",
  "./modules/app-core.js?v=5.5.9",
  "./modules/version.js?v=5.5.9",
  "./modules/store.js?v=5.5.9",
  "./modules/utils.js?v=5.5.9",
  "./modules/settings.js?v=5.5.9",
  "./modules/analytics.js?v=5.5.9",
  "./modules/bayesian.js?v=5.5.9",
  "./modules/session.js?v=5.5.9",
  "./modules/pressure.js?v=5.5.9",
  "./modules/recommendations.js?v=5.5.9",
  "./modules/render.js?v=5.5.9",
  "./modules/inference.js?v=5.5.9",
  "./manifest.json?v=5.5.9",
  "./icon.svg?v=5.5.9"
];
