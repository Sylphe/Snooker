const CACHE_VERSION = "5.7.77L-focus-mode-v2-continuous-session-flow-engine";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.77L",
  "./styles.css?v=5.7.77L",
  "./app.js?v=5.7.77L",
  "./early-theme.js?v=5.7.77L",
  "./modules/app-core.js?v=5.7.77L",
  "./modules/version.js?v=5.7.77L",
  "./modules/store.js?v=5.7.77L",
  "./modules/utils.js?v=5.7.77L",
  "./modules/settings.js?v=5.7.77L",
  "./modules/analytics.js?v=5.7.77L",
  "./modules/bayesian.js?v=5.7.77L",
  "./modules/session.js?v=5.7.77L",
  "./modules/pressure.js?v=5.7.77L",
  "./modules/recommendations.js?v=5.7.77L",
  "./modules/render.js?v=5.7.77L",
  "./modules/inference.js?v=5.7.77L",
  "./manifest.json?v=5.7.77L",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.77L",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.77L",
  "./icon.svg?v=5.7.77L"
];
