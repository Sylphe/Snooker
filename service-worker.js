const CACHE_NAME = "snooker-practice-log-v4-26-2-canonical-skill-tags";
const ASSETS = [
  "./index.html?v=4.26.2",
  "./styles.css?v=4.26.2",
  "./app.js?v=4.26.2",
  "./modules/app-core.js?v=4.26.2",
  "./modules/version.js?v=4.26.2",
  "./modules/store.js?v=4.26.2",
  "./modules/utils.js?v=4.26.2",
  "./modules/settings.js?v=4.26.2",
  "./modules/analytics.js?v=4.26.2",
  "./modules/bayesian.js?v=4.26.2",
  "./modules/session.js?v=4.26.2",
  "./modules/pressure.js?v=4.26.2",
  "./modules/recommendations.js?v=4.26.2",
  "./modules/render.js?v=4.26.2",
  "./manifest.json?v=4.26.2",
  "./icon.svg?v=4.26.2"
];
