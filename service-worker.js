const CACHE_VERSION = "5.7.46-prediction-calibration-fix";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.46",
  "./styles.css?v=5.7.46",
  "./app.js?v=5.7.46",
  "./early-theme.js?v=5.7.46",
  "./modules/app-core.js?v=5.7.46",
  "./modules/version.js?v=5.7.46",
  "./modules/store.js?v=5.7.46",
  "./modules/utils.js?v=5.7.46",
  "./modules/settings.js?v=5.7.46",
  "./modules/analytics.js?v=5.7.46",
  "./modules/bayesian.js?v=5.7.46",
  "./modules/session.js?v=5.7.46",
  "./modules/pressure.js?v=5.7.46",
  "./modules/recommendations.js?v=5.7.46",
  "./modules/render.js?v=5.7.46",
  "./modules/inference.js?v=5.7.46",
  "./manifest.json?v=5.7.46",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.46",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.46",
  "./icon.svg?v=5.7.46"
];
