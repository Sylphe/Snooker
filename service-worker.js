const CACHE_VERSION = "5.5.29-coaching-performance-pass";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.5.29",
  "./styles.css?v=5.5.29",
  "./app.js?v=5.5.29",
  "./early-theme.js?v=5.5.29",
  "./modules/app-core.js?v=5.5.29",
  "./modules/version.js?v=5.5.29",
  "./modules/store.js?v=5.5.29",
  "./modules/utils.js?v=5.5.29",
  "./modules/settings.js?v=5.5.29",
  "./modules/analytics.js?v=5.5.29",
  "./modules/bayesian.js?v=5.5.29",
  "./modules/session.js?v=5.5.29",
  "./modules/pressure.js?v=5.5.29",
  "./modules/recommendations.js?v=5.5.29",
  "./modules/render.js?v=5.5.29",
  "./modules/inference.js?v=5.5.29",
  "./manifest.json?v=5.5.29",
  "./icon.svg?v=5.5.29"
];
