const CACHE_VERSION = "5.7.77E-focus-mode-v2-gesture-interaction-layer";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.77E",
  "./styles.css?v=5.7.77E",
  "./app.js?v=5.7.77E",
  "./early-theme.js?v=5.7.77E",
  "./modules/app-core.js?v=5.7.77E",
  "./modules/version.js?v=5.7.77E",
  "./modules/store.js?v=5.7.77E",
  "./modules/utils.js?v=5.7.77E",
  "./modules/settings.js?v=5.7.77E",
  "./modules/analytics.js?v=5.7.77E",
  "./modules/bayesian.js?v=5.7.77E",
  "./modules/session.js?v=5.7.77E",
  "./modules/pressure.js?v=5.7.77E",
  "./modules/recommendations.js?v=5.7.77E",
  "./modules/render.js?v=5.7.77E",
  "./modules/inference.js?v=5.7.77E",
  "./manifest.json?v=5.7.77E",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.77E",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.77E",
  "./icon.svg?v=5.7.77E"
];
