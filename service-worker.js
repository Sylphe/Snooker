const CACHE_VERSION = "5.7.77O-focus-mode-v2-telemetry-compression-smart-hud";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.77O",
  "./styles.css?v=5.7.77O",
  "./app.js?v=5.7.77O",
  "./early-theme.js?v=5.7.77O",
  "./modules/app-core.js?v=5.7.77O",
  "./modules/version.js?v=5.7.77O",
  "./modules/store.js?v=5.7.77O",
  "./modules/utils.js?v=5.7.77O",
  "./modules/settings.js?v=5.7.77O",
  "./modules/analytics.js?v=5.7.77O",
  "./modules/bayesian.js?v=5.7.77O",
  "./modules/session.js?v=5.7.77O",
  "./modules/pressure.js?v=5.7.77O",
  "./modules/recommendations.js?v=5.7.77O",
  "./modules/render.js?v=5.7.77O",
  "./modules/inference.js?v=5.7.77O",
  "./manifest.json?v=5.7.77O",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.77O",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.77O",
  "./icon.svg?v=5.7.77O"
];
