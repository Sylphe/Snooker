const CACHE_VERSION = "5.7.37-graphs-top-level-navigation";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.37",
  "./styles.css?v=5.7.37",
  "./app.js?v=5.7.37",
  "./early-theme.js?v=5.7.37",
  "./modules/app-core.js?v=5.7.37",
  "./modules/version.js?v=5.7.37",
  "./modules/store.js?v=5.7.37",
  "./modules/utils.js?v=5.7.37",
  "./modules/settings.js?v=5.7.37",
  "./modules/analytics.js?v=5.7.37",
  "./modules/bayesian.js?v=5.7.37",
  "./modules/session.js?v=5.7.37",
  "./modules/pressure.js?v=5.7.37",
  "./modules/recommendations.js?v=5.7.37",
  "./modules/render.js?v=5.7.37",
  "./modules/inference.js?v=5.7.37",
  "./manifest.json?v=5.7.37",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.37",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.37",
  "./icon.svg?v=5.7.37"
];
