const CACHE_VERSION = "5.7.77M-focus-mode-v2-score-centric-layout";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.77M",
  "./styles.css?v=5.7.77M",
  "./app.js?v=5.7.77M",
  "./early-theme.js?v=5.7.77M",
  "./modules/app-core.js?v=5.7.77M",
  "./modules/version.js?v=5.7.77M",
  "./modules/store.js?v=5.7.77M",
  "./modules/utils.js?v=5.7.77M",
  "./modules/settings.js?v=5.7.77M",
  "./modules/analytics.js?v=5.7.77M",
  "./modules/bayesian.js?v=5.7.77M",
  "./modules/session.js?v=5.7.77M",
  "./modules/pressure.js?v=5.7.77M",
  "./modules/recommendations.js?v=5.7.77M",
  "./modules/render.js?v=5.7.77M",
  "./modules/inference.js?v=5.7.77M",
  "./manifest.json?v=5.7.77M",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.77M",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.77M",
  "./icon.svg?v=5.7.77M"
];
