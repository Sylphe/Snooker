const CACHE_VERSION = "5.5.25-skill-alias-memoization";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.5.25",
  "./styles.css?v=5.5.25",
  "./app.js?v=5.5.25",
  "./early-theme.js?v=5.5.25",
  "./modules/app-core.js?v=5.5.25",
  "./modules/version.js?v=5.5.25",
  "./modules/store.js?v=5.5.25",
  "./modules/utils.js?v=5.5.25",
  "./modules/settings.js?v=5.5.25",
  "./modules/analytics.js?v=5.5.25",
  "./modules/bayesian.js?v=5.5.25",
  "./modules/session.js?v=5.5.25",
  "./modules/pressure.js?v=5.5.25",
  "./modules/recommendations.js?v=5.5.25",
  "./modules/render.js?v=5.5.25",
  "./modules/inference.js?v=5.5.25",
  "./manifest.json?v=5.5.25",
  "./icon.svg?v=5.5.25"
];
