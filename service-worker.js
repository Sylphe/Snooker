const CACHE_VERSION = "5.7.76E-grid-database-pass-v2";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.76E",
  "./styles.css?v=5.7.76E",
  "./app.js?v=5.7.76E",
  "./early-theme.js?v=5.7.76E",
  "./modules/app-core.js?v=5.7.76E",
  "./modules/version.js?v=5.7.76E",
  "./modules/store.js?v=5.7.76E",
  "./modules/utils.js?v=5.7.76E",
  "./modules/settings.js?v=5.7.76E",
  "./modules/analytics.js?v=5.7.76E",
  "./modules/bayesian.js?v=5.7.76E",
  "./modules/session.js?v=5.7.76E",
  "./modules/pressure.js?v=5.7.76E",
  "./modules/recommendations.js?v=5.7.76E",
  "./modules/render.js?v=5.7.76E",
  "./modules/inference.js?v=5.7.76E",
  "./manifest.json?v=5.7.76E",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.76E",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.76E",
  "./icon.svg?v=5.7.76E"
];
