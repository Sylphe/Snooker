const CACHE_VERSION = "5.7.76G-left-navigation-rail";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.76G",
  "./styles.css?v=5.7.76G",
  "./app.js?v=5.7.76G",
  "./early-theme.js?v=5.7.76G",
  "./modules/app-core.js?v=5.7.76G",
  "./modules/version.js?v=5.7.76G",
  "./modules/store.js?v=5.7.76G",
  "./modules/utils.js?v=5.7.76G",
  "./modules/settings.js?v=5.7.76G",
  "./modules/analytics.js?v=5.7.76G",
  "./modules/bayesian.js?v=5.7.76G",
  "./modules/session.js?v=5.7.76G",
  "./modules/pressure.js?v=5.7.76G",
  "./modules/recommendations.js?v=5.7.76G",
  "./modules/render.js?v=5.7.76G",
  "./modules/inference.js?v=5.7.76G",
  "./manifest.json?v=5.7.76G",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.76G",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.76G",
  "./icon.svg?v=5.7.76G"
];
