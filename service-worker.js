const CACHE_VERSION = "5.7.71-routine-schema-audit";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.71",
  "./styles.css?v=5.7.71",
  "./app.js?v=5.7.71",
  "./early-theme.js?v=5.7.71",
  "./modules/app-core.js?v=5.7.71",
  "./modules/version.js?v=5.7.71",
  "./modules/store.js?v=5.7.71",
  "./modules/utils.js?v=5.7.71",
  "./modules/settings.js?v=5.7.71",
  "./modules/analytics.js?v=5.7.71",
  "./modules/bayesian.js?v=5.7.71",
  "./modules/session.js?v=5.7.71",
  "./modules/pressure.js?v=5.7.71",
  "./modules/recommendations.js?v=5.7.71",
  "./modules/render.js?v=5.7.71",
  "./modules/inference.js?v=5.7.71",
  "./manifest.json?v=5.7.71",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.71",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.71",
  "./icon.svg?v=5.7.71"
];
