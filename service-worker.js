const CACHE_VERSION = "5.7.65-session-review-refinement";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.65",
  "./styles.css?v=5.7.65",
  "./app.js?v=5.7.65",
  "./early-theme.js?v=5.7.65",
  "./modules/app-core.js?v=5.7.65",
  "./modules/version.js?v=5.7.65",
  "./modules/store.js?v=5.7.65",
  "./modules/utils.js?v=5.7.65",
  "./modules/settings.js?v=5.7.65",
  "./modules/analytics.js?v=5.7.65",
  "./modules/bayesian.js?v=5.7.65",
  "./modules/session.js?v=5.7.65",
  "./modules/pressure.js?v=5.7.65",
  "./modules/recommendations.js?v=5.7.65",
  "./modules/render.js?v=5.7.65",
  "./modules/inference.js?v=5.7.65",
  "./manifest.json?v=5.7.65",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.65",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.65",
  "./icon.svg?v=5.7.65"
];
