const CACHE_VERSION = "5.7.75H-semantic-readiness-dashboard";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.75H",
  "./styles.css?v=5.7.75H",
  "./app.js?v=5.7.75H",
  "./early-theme.js?v=5.7.75H",
  "./modules/app-core.js?v=5.7.75H",
  "./modules/version.js?v=5.7.75H",
  "./modules/store.js?v=5.7.75H",
  "./modules/utils.js?v=5.7.75H",
  "./modules/settings.js?v=5.7.75H",
  "./modules/analytics.js?v=5.7.75H",
  "./modules/bayesian.js?v=5.7.75H",
  "./modules/session.js?v=5.7.75H",
  "./modules/pressure.js?v=5.7.75H",
  "./modules/recommendations.js?v=5.7.75H",
  "./modules/render.js?v=5.7.75H",
  "./modules/inference.js?v=5.7.75H",
  "./manifest.json?v=5.7.75H",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.75H",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.75H",
  "./icon.svg?v=5.7.75H"
];
