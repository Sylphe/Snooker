const CACHE_VERSION = "5.7.35-migration-constant-init-fix";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.35",
  "./styles.css?v=5.7.35",
  "./app.js?v=5.7.35",
  "./early-theme.js?v=5.7.35",
  "./modules/app-core.js?v=5.7.35",
  "./modules/version.js?v=5.7.35",
  "./modules/store.js?v=5.7.35",
  "./modules/utils.js?v=5.7.35",
  "./modules/settings.js?v=5.7.35",
  "./modules/analytics.js?v=5.7.35",
  "./modules/bayesian.js?v=5.7.35",
  "./modules/session.js?v=5.7.35",
  "./modules/pressure.js?v=5.7.35",
  "./modules/recommendations.js?v=5.7.35",
  "./modules/render.js?v=5.7.35",
  "./modules/inference.js?v=5.7.35",
  "./manifest.json?v=5.7.35",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.35",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.35",
  "./icon.svg?v=5.7.35"
];
