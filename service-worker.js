const CACHE_NAME = "snooker-practice-log-v4-26-1-reflection-skill-map";
const ASSETS = [
  "./index.html?v=4.26.1",
  "./styles.css?v=4.26.1",
  "./app.js?v=4.26.1",
  "./modules/app-core.js?v=4.26.1",
  "./modules/version.js?v=4.26.1",
  "./modules/store.js?v=4.26.1",
  "./modules/utils.js?v=4.26.1",
  "./modules/settings.js?v=4.26.1",
  "./modules/analytics.js?v=4.26.1",
  "./modules/bayesian.js?v=4.26.1",
  "./modules/session.js?v=4.26.1",
  "./modules/pressure.js?v=4.26.1",
  "./modules/recommendations.js?v=4.26.1",
  "./modules/render.js?v=4.26.1",
  "./manifest.json?v=4.26.1",
  "./icon.svg?v=4.26.1"
];
