const CACHE_VERSION = "5.7.42-stats-render-performance-pass";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.42",
  "./styles.css?v=5.7.42",
  "./app.js?v=5.7.42",
  "./early-theme.js?v=5.7.42",
  "./modules/app-core.js?v=5.7.42",
  "./modules/version.js?v=5.7.42",
  "./modules/store.js?v=5.7.42",
  "./modules/utils.js?v=5.7.42",
  "./modules/settings.js?v=5.7.42",
  "./modules/analytics.js?v=5.7.42",
  "./modules/bayesian.js?v=5.7.42",
  "./modules/session.js?v=5.7.42",
  "./modules/pressure.js?v=5.7.42",
  "./modules/recommendations.js?v=5.7.42",
  "./modules/render.js?v=5.7.42",
  "./modules/inference.js?v=5.7.42",
  "./manifest.json?v=5.7.42",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.42",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.42",
  "./icon.svg?v=5.7.42"
];
