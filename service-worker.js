const CACHE_VERSION = "5.7.56-etu-calibration-pass";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.56",
  "./styles.css?v=5.7.56",
  "./app.js?v=5.7.56",
  "./early-theme.js?v=5.7.56",
  "./modules/app-core.js?v=5.7.56",
  "./modules/version.js?v=5.7.56",
  "./modules/store.js?v=5.7.56",
  "./modules/utils.js?v=5.7.56",
  "./modules/settings.js?v=5.7.56",
  "./modules/analytics.js?v=5.7.56",
  "./modules/bayesian.js?v=5.7.56",
  "./modules/session.js?v=5.7.56",
  "./modules/pressure.js?v=5.7.56",
  "./modules/recommendations.js?v=5.7.56",
  "./modules/render.js?v=5.7.56",
  "./modules/inference.js?v=5.7.56",
  "./manifest.json?v=5.7.56",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.56",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.56",
  "./icon.svg?v=5.7.56"
];
