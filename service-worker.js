const CACHE_VERSION = "5.7.21-pack-schema-alignment-audit-fix";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.21",
  "./styles.css?v=5.7.21",
  "./app.js?v=5.7.21",
  "./early-theme.js?v=5.7.21",
  "./modules/app-core.js?v=5.7.21",
  "./modules/version.js?v=5.7.21",
  "./modules/store.js?v=5.7.21",
  "./modules/utils.js?v=5.7.21",
  "./modules/settings.js?v=5.7.21",
  "./modules/analytics.js?v=5.7.21",
  "./modules/bayesian.js?v=5.7.21",
  "./modules/session.js?v=5.7.21",
  "./modules/pressure.js?v=5.7.21",
  "./modules/recommendations.js?v=5.7.21",
  "./modules/render.js?v=5.7.21",
  "./modules/inference.js?v=5.7.21",
  "./manifest.json?v=5.7.21",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.21",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.21",
  "./icon.svg?v=5.7.21"
];
