const CACHE_VERSION = "5.7.77T-focus-mode-v2-pre-shot-compression-review-reduction";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.77T",
  "./styles.css?v=5.7.77T",
  "./app.js?v=5.7.77T",
  "./early-theme.js?v=5.7.77T",
  "./modules/app-core.js?v=5.7.77T",
  "./modules/version.js?v=5.7.77T",
  "./modules/store.js?v=5.7.77T",
  "./modules/utils.js?v=5.7.77T",
  "./modules/settings.js?v=5.7.77T",
  "./modules/analytics.js?v=5.7.77T",
  "./modules/bayesian.js?v=5.7.77T",
  "./modules/session.js?v=5.7.77T",
  "./modules/pressure.js?v=5.7.77T",
  "./modules/recommendations.js?v=5.7.77T",
  "./modules/render.js?v=5.7.77T",
  "./modules/inference.js?v=5.7.77T",
  "./manifest.json?v=5.7.77T",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.77T",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.77T",
  "./icon.svg?v=5.7.77T"
];
