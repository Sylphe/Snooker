const CACHE_VERSION = "5.7.11-routine-edit-save-hydration-fix";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.11",
  "./styles.css?v=5.7.11",
  "./app.js?v=5.7.11",
  "./early-theme.js?v=5.7.11",
  "./modules/app-core.js?v=5.7.11",
  "./modules/version.js?v=5.7.11",
  "./modules/store.js?v=5.7.11",
  "./modules/utils.js?v=5.7.11",
  "./modules/settings.js?v=5.7.11",
  "./modules/analytics.js?v=5.7.11",
  "./modules/bayesian.js?v=5.7.11",
  "./modules/session.js?v=5.7.11",
  "./modules/pressure.js?v=5.7.11",
  "./modules/recommendations.js?v=5.7.11",
  "./modules/render.js?v=5.7.11",
  "./modules/inference.js?v=5.7.11",
  "./manifest.json?v=5.7.11",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.11",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.11",
  "./icon.svg?v=5.7.11"
];
