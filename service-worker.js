const CACHE_VERSION = "5.6.18-target-clarity-formatting";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.6.18",
  "./styles.css?v=5.6.18",
  "./app.js?v=5.6.18",
  "./early-theme.js?v=5.6.18",
  "./modules/app-core.js?v=5.6.18",
  "./modules/version.js?v=5.6.18",
  "./modules/store.js?v=5.6.18",
  "./modules/utils.js?v=5.6.18",
  "./modules/settings.js?v=5.6.18",
  "./modules/analytics.js?v=5.6.18",
  "./modules/bayesian.js?v=5.6.18",
  "./modules/session.js?v=5.6.18",
  "./modules/pressure.js?v=5.6.18",
  "./modules/recommendations.js?v=5.6.18",
  "./modules/render.js?v=5.6.18",
  "./modules/inference.js?v=5.6.18",
  "./manifest.json?v=5.6.18",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.6.18",
  "./icon.svg?v=5.6.18"
];
