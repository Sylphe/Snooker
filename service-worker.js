const CACHE_VERSION = "5.7.33-data-center-ui-redesign";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.33",
  "./styles.css?v=5.7.33",
  "./app.js?v=5.7.33",
  "./early-theme.js?v=5.7.33",
  "./modules/app-core.js?v=5.7.33",
  "./modules/version.js?v=5.7.33",
  "./modules/store.js?v=5.7.33",
  "./modules/utils.js?v=5.7.33",
  "./modules/settings.js?v=5.7.33",
  "./modules/analytics.js?v=5.7.33",
  "./modules/bayesian.js?v=5.7.33",
  "./modules/session.js?v=5.7.33",
  "./modules/pressure.js?v=5.7.33",
  "./modules/recommendations.js?v=5.7.33",
  "./modules/render.js?v=5.7.33",
  "./modules/inference.js?v=5.7.33",
  "./manifest.json?v=5.7.33",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.33",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.33",
  "./icon.svg?v=5.7.33"
];
