const CACHE_VERSION = "5.7.43-inferred-skill-ui-clarity";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.43",
  "./styles.css?v=5.7.43",
  "./app.js?v=5.7.43",
  "./early-theme.js?v=5.7.43",
  "./modules/app-core.js?v=5.7.43",
  "./modules/version.js?v=5.7.43",
  "./modules/store.js?v=5.7.43",
  "./modules/utils.js?v=5.7.43",
  "./modules/settings.js?v=5.7.43",
  "./modules/analytics.js?v=5.7.43",
  "./modules/bayesian.js?v=5.7.43",
  "./modules/session.js?v=5.7.43",
  "./modules/pressure.js?v=5.7.43",
  "./modules/recommendations.js?v=5.7.43",
  "./modules/render.js?v=5.7.43",
  "./modules/inference.js?v=5.7.43",
  "./manifest.json?v=5.7.43",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.43",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.43",
  "./icon.svg?v=5.7.43"
];
