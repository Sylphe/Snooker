const CACHE_VERSION = "5.7.76B-governance-kpi-dashboard-pass";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.76B",
  "./styles.css?v=5.7.76B",
  "./app.js?v=5.7.76B",
  "./early-theme.js?v=5.7.76B",
  "./modules/app-core.js?v=5.7.76B",
  "./modules/version.js?v=5.7.76B",
  "./modules/store.js?v=5.7.76B",
  "./modules/utils.js?v=5.7.76B",
  "./modules/settings.js?v=5.7.76B",
  "./modules/analytics.js?v=5.7.76B",
  "./modules/bayesian.js?v=5.7.76B",
  "./modules/session.js?v=5.7.76B",
  "./modules/pressure.js?v=5.7.76B",
  "./modules/recommendations.js?v=5.7.76B",
  "./modules/render.js?v=5.7.76B",
  "./modules/inference.js?v=5.7.76B",
  "./manifest.json?v=5.7.76B",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.76B",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.76B",
  "./icon.svg?v=5.7.76B"
];
