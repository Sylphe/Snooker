const CACHE_VERSION = "5.5.21-lazy-stats-rendering";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.5.21",
  "./styles.css?v=5.5.21",
  "./app.js?v=5.5.21",
  "./early-theme.js?v=5.5.21",
  "./modules/app-core.js?v=5.5.21",
  "./modules/version.js?v=5.5.21",
  "./modules/store.js?v=5.5.21",
  "./modules/utils.js?v=5.5.21",
  "./modules/settings.js?v=5.5.21",
  "./modules/analytics.js?v=5.5.21",
  "./modules/bayesian.js?v=5.5.21",
  "./modules/session.js?v=5.5.21",
  "./modules/pressure.js?v=5.5.21",
  "./modules/recommendations.js?v=5.5.21",
  "./modules/render.js?v=5.5.21",
  "./modules/inference.js?v=5.5.21",
  "./manifest.json?v=5.5.21",
  "./icon.svg?v=5.5.21"
];
