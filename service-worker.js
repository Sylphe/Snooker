const CACHE_VERSION = "5.7.61-smart-builder-etu-integration";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.61",
  "./styles.css?v=5.7.61",
  "./app.js?v=5.7.61",
  "./early-theme.js?v=5.7.61",
  "./modules/app-core.js?v=5.7.61",
  "./modules/version.js?v=5.7.61",
  "./modules/store.js?v=5.7.61",
  "./modules/utils.js?v=5.7.61",
  "./modules/settings.js?v=5.7.61",
  "./modules/analytics.js?v=5.7.61",
  "./modules/bayesian.js?v=5.7.61",
  "./modules/session.js?v=5.7.61",
  "./modules/pressure.js?v=5.7.61",
  "./modules/recommendations.js?v=5.7.61",
  "./modules/render.js?v=5.7.61",
  "./modules/inference.js?v=5.7.61",
  "./manifest.json?v=5.7.61",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.61",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.61",
  "./icon.svg?v=5.7.61"
];
