const CACHE_VERSION = "5.7.63-session-end-review-dashboard";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.63",
  "./styles.css?v=5.7.63",
  "./app.js?v=5.7.63",
  "./early-theme.js?v=5.7.63",
  "./modules/app-core.js?v=5.7.63",
  "./modules/version.js?v=5.7.63",
  "./modules/store.js?v=5.7.63",
  "./modules/utils.js?v=5.7.63",
  "./modules/settings.js?v=5.7.63",
  "./modules/analytics.js?v=5.7.63",
  "./modules/bayesian.js?v=5.7.63",
  "./modules/session.js?v=5.7.63",
  "./modules/pressure.js?v=5.7.63",
  "./modules/recommendations.js?v=5.7.63",
  "./modules/render.js?v=5.7.63",
  "./modules/inference.js?v=5.7.63",
  "./manifest.json?v=5.7.63",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.63",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.63",
  "./icon.svg?v=5.7.63"
];
