const CACHE_VERSION = "5.7.77A-focus-mode-v2-state-architecture";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.77A",
  "./styles.css?v=5.7.77A",
  "./app.js?v=5.7.77A",
  "./early-theme.js?v=5.7.77A",
  "./modules/app-core.js?v=5.7.77A",
  "./modules/version.js?v=5.7.77A",
  "./modules/store.js?v=5.7.77A",
  "./modules/utils.js?v=5.7.77A",
  "./modules/settings.js?v=5.7.77A",
  "./modules/analytics.js?v=5.7.77A",
  "./modules/bayesian.js?v=5.7.77A",
  "./modules/session.js?v=5.7.77A",
  "./modules/pressure.js?v=5.7.77A",
  "./modules/recommendations.js?v=5.7.77A",
  "./modules/render.js?v=5.7.77A",
  "./modules/inference.js?v=5.7.77A",
  "./manifest.json?v=5.7.77A",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.77A",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.77A",
  "./icon.svg?v=5.7.77A"
];
