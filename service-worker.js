const CACHE_VERSION = "5.7.60-etu-by-skill-domain";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.60",
  "./styles.css?v=5.7.60",
  "./app.js?v=5.7.60",
  "./early-theme.js?v=5.7.60",
  "./modules/app-core.js?v=5.7.60",
  "./modules/version.js?v=5.7.60",
  "./modules/store.js?v=5.7.60",
  "./modules/utils.js?v=5.7.60",
  "./modules/settings.js?v=5.7.60",
  "./modules/analytics.js?v=5.7.60",
  "./modules/bayesian.js?v=5.7.60",
  "./modules/session.js?v=5.7.60",
  "./modules/pressure.js?v=5.7.60",
  "./modules/recommendations.js?v=5.7.60",
  "./modules/render.js?v=5.7.60",
  "./modules/inference.js?v=5.7.60",
  "./manifest.json?v=5.7.60",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.60",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.60",
  "./icon.svg?v=5.7.60"
];
