const CACHE_VERSION = "5.7.45-prediction-engine-bootstrap-safe";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.45",
  "./styles.css?v=5.7.45",
  "./app.js?v=5.7.45",
  "./early-theme.js?v=5.7.45",
  "./modules/app-core.js?v=5.7.45",
  "./modules/version.js?v=5.7.45",
  "./modules/store.js?v=5.7.45",
  "./modules/utils.js?v=5.7.45",
  "./modules/settings.js?v=5.7.45",
  "./modules/analytics.js?v=5.7.45",
  "./modules/bayesian.js?v=5.7.45",
  "./modules/session.js?v=5.7.45",
  "./modules/pressure.js?v=5.7.45",
  "./modules/recommendations.js?v=5.7.45",
  "./modules/render.js?v=5.7.45",
  "./modules/inference.js?v=5.7.45",
  "./manifest.json?v=5.7.45",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.45",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.45",
  "./icon.svg?v=5.7.45"
];
