const CACHE_VERSION = "5.7.77B-focus-mode-v2-thumb-zone-mobile-layout";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.77B",
  "./styles.css?v=5.7.77B",
  "./app.js?v=5.7.77B",
  "./early-theme.js?v=5.7.77B",
  "./modules/app-core.js?v=5.7.77B",
  "./modules/version.js?v=5.7.77B",
  "./modules/store.js?v=5.7.77B",
  "./modules/utils.js?v=5.7.77B",
  "./modules/settings.js?v=5.7.77B",
  "./modules/analytics.js?v=5.7.77B",
  "./modules/bayesian.js?v=5.7.77B",
  "./modules/session.js?v=5.7.77B",
  "./modules/pressure.js?v=5.7.77B",
  "./modules/recommendations.js?v=5.7.77B",
  "./modules/render.js?v=5.7.77B",
  "./modules/inference.js?v=5.7.77B",
  "./manifest.json?v=5.7.77B",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.77B",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.77B",
  "./icon.svg?v=5.7.77B"
];
