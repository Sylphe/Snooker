const CACHE_VERSION = "5.7.52-prediction-visualization-safe-rebuild";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.52",
  "./styles.css?v=5.7.52",
  "./app.js?v=5.7.52",
  "./early-theme.js?v=5.7.52",
  "./modules/app-core.js?v=5.7.52",
  "./modules/version.js?v=5.7.52",
  "./modules/store.js?v=5.7.52",
  "./modules/utils.js?v=5.7.52",
  "./modules/settings.js?v=5.7.52",
  "./modules/analytics.js?v=5.7.52",
  "./modules/bayesian.js?v=5.7.52",
  "./modules/session.js?v=5.7.52",
  "./modules/pressure.js?v=5.7.52",
  "./modules/recommendations.js?v=5.7.52",
  "./modules/render.js?v=5.7.52",
  "./modules/inference.js?v=5.7.52",
  "./manifest.json?v=5.7.52",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.52",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.52",
  "./icon.svg?v=5.7.52"
];
