const CACHE_VERSION = "5.7.74E-semantic-preset-system";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.74E",
  "./styles.css?v=5.7.74E",
  "./app.js?v=5.7.74E",
  "./early-theme.js?v=5.7.74E",
  "./modules/app-core.js?v=5.7.74E",
  "./modules/version.js?v=5.7.74E",
  "./modules/store.js?v=5.7.74E",
  "./modules/utils.js?v=5.7.74E",
  "./modules/settings.js?v=5.7.74E",
  "./modules/analytics.js?v=5.7.74E",
  "./modules/bayesian.js?v=5.7.74E",
  "./modules/session.js?v=5.7.74E",
  "./modules/pressure.js?v=5.7.74E",
  "./modules/recommendations.js?v=5.7.74E",
  "./modules/render.js?v=5.7.74E",
  "./modules/inference.js?v=5.7.74E",
  "./manifest.json?v=5.7.74E",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.74E",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.74E",
  "./icon.svg?v=5.7.74E"
];
