const CACHE_VERSION = "5.7.74A-routine-management-console";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.74A",
  "./styles.css?v=5.7.74A",
  "./app.js?v=5.7.74A",
  "./early-theme.js?v=5.7.74A",
  "./modules/app-core.js?v=5.7.74A",
  "./modules/version.js?v=5.7.74A",
  "./modules/store.js?v=5.7.74A",
  "./modules/utils.js?v=5.7.74A",
  "./modules/settings.js?v=5.7.74A",
  "./modules/analytics.js?v=5.7.74A",
  "./modules/bayesian.js?v=5.7.74A",
  "./modules/session.js?v=5.7.74A",
  "./modules/pressure.js?v=5.7.74A",
  "./modules/recommendations.js?v=5.7.74A",
  "./modules/render.js?v=5.7.74A",
  "./modules/inference.js?v=5.7.74A",
  "./manifest.json?v=5.7.74A",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.74A",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.74A",
  "./icon.svg?v=5.7.74A"
];
