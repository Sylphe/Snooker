const CACHE_VERSION = "5.6.13.4-insights-radar-fix";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.6.13.4",
  "./styles.css?v=5.6.13.4",
  "./app.js?v=5.6.13.4",
  "./early-theme.js?v=5.6.13.4",
  "./modules/app-core.js?v=5.6.13.4",
  "./modules/version.js?v=5.6.13.4",
  "./modules/store.js?v=5.6.13.4",
  "./modules/utils.js?v=5.6.13.4",
  "./modules/settings.js?v=5.6.13.4",
  "./modules/analytics.js?v=5.6.13.4",
  "./modules/bayesian.js?v=5.6.13.4",
  "./modules/session.js?v=5.6.13.4",
  "./modules/pressure.js?v=5.6.13.4",
  "./modules/recommendations.js?v=5.6.13.4",
  "./modules/render.js?v=5.6.13.4",
  "./modules/inference.js?v=5.6.13.4",
  "./manifest.json?v=5.6.13.4",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.6.13.4",
  "./icon.svg?v=5.6.13.4"
];
