const CACHE_VERSION = "5.7.75A-visual-transfer-graph-editor";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.75A",
  "./styles.css?v=5.7.75A",
  "./app.js?v=5.7.75A",
  "./early-theme.js?v=5.7.75A",
  "./modules/app-core.js?v=5.7.75A",
  "./modules/version.js?v=5.7.75A",
  "./modules/store.js?v=5.7.75A",
  "./modules/utils.js?v=5.7.75A",
  "./modules/settings.js?v=5.7.75A",
  "./modules/analytics.js?v=5.7.75A",
  "./modules/bayesian.js?v=5.7.75A",
  "./modules/session.js?v=5.7.75A",
  "./modules/pressure.js?v=5.7.75A",
  "./modules/recommendations.js?v=5.7.75A",
  "./modules/render.js?v=5.7.75A",
  "./modules/inference.js?v=5.7.75A",
  "./manifest.json?v=5.7.75A",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.75A",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.75A",
  "./icon.svg?v=5.7.75A"
];
