const CACHE_VERSION = "5.7.73-routine-validation-engine";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.73",
  "./styles.css?v=5.7.73",
  "./app.js?v=5.7.73",
  "./early-theme.js?v=5.7.73",
  "./modules/app-core.js?v=5.7.73",
  "./modules/version.js?v=5.7.73",
  "./modules/store.js?v=5.7.73",
  "./modules/utils.js?v=5.7.73",
  "./modules/settings.js?v=5.7.73",
  "./modules/analytics.js?v=5.7.73",
  "./modules/bayesian.js?v=5.7.73",
  "./modules/session.js?v=5.7.73",
  "./modules/pressure.js?v=5.7.73",
  "./modules/recommendations.js?v=5.7.73",
  "./modules/render.js?v=5.7.73",
  "./modules/inference.js?v=5.7.73",
  "./manifest.json?v=5.7.73",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.73",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.73",
  "./icon.svg?v=5.7.73"
];
