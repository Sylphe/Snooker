const CACHE_VERSION = "5.7.53-etu-history-visuals";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.53",
  "./styles.css?v=5.7.53",
  "./app.js?v=5.7.53",
  "./early-theme.js?v=5.7.53",
  "./modules/app-core.js?v=5.7.53",
  "./modules/version.js?v=5.7.53",
  "./modules/store.js?v=5.7.53",
  "./modules/utils.js?v=5.7.53",
  "./modules/settings.js?v=5.7.53",
  "./modules/analytics.js?v=5.7.53",
  "./modules/bayesian.js?v=5.7.53",
  "./modules/session.js?v=5.7.53",
  "./modules/pressure.js?v=5.7.53",
  "./modules/recommendations.js?v=5.7.53",
  "./modules/render.js?v=5.7.53",
  "./modules/inference.js?v=5.7.53",
  "./manifest.json?v=5.7.53",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.53",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.53",
  "./icon.svg?v=5.7.53"
];
