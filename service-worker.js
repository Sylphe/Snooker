const CACHE_VERSION = "5.7.58-recovery-readiness-engine";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.58",
  "./styles.css?v=5.7.58",
  "./app.js?v=5.7.58",
  "./early-theme.js?v=5.7.58",
  "./modules/app-core.js?v=5.7.58",
  "./modules/version.js?v=5.7.58",
  "./modules/store.js?v=5.7.58",
  "./modules/utils.js?v=5.7.58",
  "./modules/settings.js?v=5.7.58",
  "./modules/analytics.js?v=5.7.58",
  "./modules/bayesian.js?v=5.7.58",
  "./modules/session.js?v=5.7.58",
  "./modules/pressure.js?v=5.7.58",
  "./modules/recommendations.js?v=5.7.58",
  "./modules/render.js?v=5.7.58",
  "./modules/inference.js?v=5.7.58",
  "./manifest.json?v=5.7.58",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.58",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.58",
  "./icon.svg?v=5.7.58"
];
