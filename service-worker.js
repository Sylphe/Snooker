const CACHE_VERSION = "5.7.75J-visual-dependency-chain-viewer";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.75J",
  "./styles.css?v=5.7.75J",
  "./app.js?v=5.7.75J",
  "./early-theme.js?v=5.7.75J",
  "./modules/app-core.js?v=5.7.75J",
  "./modules/version.js?v=5.7.75J",
  "./modules/store.js?v=5.7.75J",
  "./modules/utils.js?v=5.7.75J",
  "./modules/settings.js?v=5.7.75J",
  "./modules/analytics.js?v=5.7.75J",
  "./modules/bayesian.js?v=5.7.75J",
  "./modules/session.js?v=5.7.75J",
  "./modules/pressure.js?v=5.7.75J",
  "./modules/recommendations.js?v=5.7.75J",
  "./modules/render.js?v=5.7.75J",
  "./modules/inference.js?v=5.7.75J",
  "./manifest.json?v=5.7.75J",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.75J",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.75J",
  "./icon.svg?v=5.7.75J"
];
