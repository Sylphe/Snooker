const CACHE_VERSION = "5.7.67.6-bottleneck-semantics-progressive-disclosure";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.67.6",
  "./styles.css?v=5.7.67.6",
  "./app.js?v=5.7.67.6",
  "./early-theme.js?v=5.7.67.6",
  "./modules/app-core.js?v=5.7.67.6",
  "./modules/version.js?v=5.7.67.6",
  "./modules/store.js?v=5.7.67.6",
  "./modules/utils.js?v=5.7.67.6",
  "./modules/settings.js?v=5.7.67.6",
  "./modules/analytics.js?v=5.7.67.6",
  "./modules/bayesian.js?v=5.7.67.6",
  "./modules/session.js?v=5.7.67.6",
  "./modules/pressure.js?v=5.7.67.6",
  "./modules/recommendations.js?v=5.7.67.6",
  "./modules/render.js?v=5.7.67.6",
  "./modules/inference.js?v=5.7.67.6",
  "./manifest.json?v=5.7.67.6",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.67.6",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.67.6",
  "./icon.svg?v=5.7.67.6"
];
