const CACHE_VERSION = "5.5.11-small-hardening";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.5.11",
  "./styles.css?v=5.5.11",
  "./app.js?v=5.5.11",
  "./modules/app-core.js?v=5.5.11",
  "./modules/version.js?v=5.5.11",
  "./modules/store.js?v=5.5.11",
  "./modules/utils.js?v=5.5.11",
  "./modules/settings.js?v=5.5.11",
  "./modules/analytics.js?v=5.5.11",
  "./modules/bayesian.js?v=5.5.11",
  "./modules/session.js?v=5.5.11",
  "./modules/pressure.js?v=5.5.11",
  "./modules/recommendations.js?v=5.5.11",
  "./modules/render.js?v=5.5.11",
  "./modules/inference.js?v=5.5.11",
  "./manifest.json?v=5.5.11",
  "./icon.svg?v=5.5.11"
];
