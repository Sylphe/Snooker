const CACHE_VERSION = "5.5.26-routine-stats-cache";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.5.26",
  "./styles.css?v=5.5.26",
  "./app.js?v=5.5.26",
  "./early-theme.js?v=5.5.26",
  "./modules/app-core.js?v=5.5.26",
  "./modules/version.js?v=5.5.26",
  "./modules/store.js?v=5.5.26",
  "./modules/utils.js?v=5.5.26",
  "./modules/settings.js?v=5.5.26",
  "./modules/analytics.js?v=5.5.26",
  "./modules/bayesian.js?v=5.5.26",
  "./modules/session.js?v=5.5.26",
  "./modules/pressure.js?v=5.5.26",
  "./modules/recommendations.js?v=5.5.26",
  "./modules/render.js?v=5.5.26",
  "./modules/inference.js?v=5.5.26",
  "./manifest.json?v=5.5.26",
  "./icon.svg?v=5.5.26"
];
