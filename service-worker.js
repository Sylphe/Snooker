const CACHE_VERSION = "5.5.24-swipe-history-cap";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.5.24",
  "./styles.css?v=5.5.24",
  "./app.js?v=5.5.24",
  "./early-theme.js?v=5.5.24",
  "./modules/app-core.js?v=5.5.24",
  "./modules/version.js?v=5.5.24",
  "./modules/store.js?v=5.5.24",
  "./modules/utils.js?v=5.5.24",
  "./modules/settings.js?v=5.5.24",
  "./modules/analytics.js?v=5.5.24",
  "./modules/bayesian.js?v=5.5.24",
  "./modules/session.js?v=5.5.24",
  "./modules/pressure.js?v=5.5.24",
  "./modules/recommendations.js?v=5.5.24",
  "./modules/render.js?v=5.5.24",
  "./modules/inference.js?v=5.5.24",
  "./manifest.json?v=5.5.24",
  "./icon.svg?v=5.5.24"
];
