const CACHE_VERSION = "5.7.32-recommendation-action-safety";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.32",
  "./styles.css?v=5.7.32",
  "./app.js?v=5.7.32",
  "./early-theme.js?v=5.7.32",
  "./modules/app-core.js?v=5.7.32",
  "./modules/version.js?v=5.7.32",
  "./modules/store.js?v=5.7.32",
  "./modules/utils.js?v=5.7.32",
  "./modules/settings.js?v=5.7.32",
  "./modules/analytics.js?v=5.7.32",
  "./modules/bayesian.js?v=5.7.32",
  "./modules/session.js?v=5.7.32",
  "./modules/pressure.js?v=5.7.32",
  "./modules/recommendations.js?v=5.7.32",
  "./modules/render.js?v=5.7.32",
  "./modules/inference.js?v=5.7.32",
  "./manifest.json?v=5.7.32",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.32",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.32",
  "./icon.svg?v=5.7.32"
];
