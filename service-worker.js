const CACHE_VERSION = "5.7.77I-focus-mode-v2-persistent-session-memory";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.77I",
  "./styles.css?v=5.7.77I",
  "./app.js?v=5.7.77I",
  "./early-theme.js?v=5.7.77I",
  "./modules/app-core.js?v=5.7.77I",
  "./modules/version.js?v=5.7.77I",
  "./modules/store.js?v=5.7.77I",
  "./modules/utils.js?v=5.7.77I",
  "./modules/settings.js?v=5.7.77I",
  "./modules/analytics.js?v=5.7.77I",
  "./modules/bayesian.js?v=5.7.77I",
  "./modules/session.js?v=5.7.77I",
  "./modules/pressure.js?v=5.7.77I",
  "./modules/recommendations.js?v=5.7.77I",
  "./modules/render.js?v=5.7.77I",
  "./modules/inference.js?v=5.7.77I",
  "./manifest.json?v=5.7.77I",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.77I",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.77I",
  "./icon.svg?v=5.7.77I"
];
