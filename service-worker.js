const CACHE_VERSION = "5.7.48-effective-training-load-predictions";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.48",
  "./styles.css?v=5.7.48",
  "./app.js?v=5.7.48",
  "./early-theme.js?v=5.7.48",
  "./modules/app-core.js?v=5.7.48",
  "./modules/version.js?v=5.7.48",
  "./modules/store.js?v=5.7.48",
  "./modules/utils.js?v=5.7.48",
  "./modules/settings.js?v=5.7.48",
  "./modules/analytics.js?v=5.7.48",
  "./modules/bayesian.js?v=5.7.48",
  "./modules/session.js?v=5.7.48",
  "./modules/pressure.js?v=5.7.48",
  "./modules/recommendations.js?v=5.7.48",
  "./modules/render.js?v=5.7.48",
  "./modules/inference.js?v=5.7.48",
  "./manifest.json?v=5.7.48",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.48",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.48",
  "./icon.svg?v=5.7.48"
];
