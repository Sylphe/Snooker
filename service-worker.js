const CACHE_VERSION = "5.7.62-smart-builder-etu-wiring-fix";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.62",
  "./styles.css?v=5.7.62",
  "./app.js?v=5.7.62",
  "./early-theme.js?v=5.7.62",
  "./modules/app-core.js?v=5.7.62",
  "./modules/version.js?v=5.7.62",
  "./modules/store.js?v=5.7.62",
  "./modules/utils.js?v=5.7.62",
  "./modules/settings.js?v=5.7.62",
  "./modules/analytics.js?v=5.7.62",
  "./modules/bayesian.js?v=5.7.62",
  "./modules/session.js?v=5.7.62",
  "./modules/pressure.js?v=5.7.62",
  "./modules/recommendations.js?v=5.7.62",
  "./modules/render.js?v=5.7.62",
  "./modules/inference.js?v=5.7.62",
  "./manifest.json?v=5.7.62",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.62",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.62",
  "./icon.svg?v=5.7.62"
];
