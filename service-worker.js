const CACHE_VERSION = "5.5.19-defaults-forecast-hardening";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.5.19",
  "./styles.css?v=5.5.19",
  "./app.js?v=5.5.19",
  "./early-theme.js?v=5.5.19",
  "./modules/app-core.js?v=5.5.19",
  "./modules/version.js?v=5.5.19",
  "./modules/store.js?v=5.5.19",
  "./modules/utils.js?v=5.5.19",
  "./modules/settings.js?v=5.5.19",
  "./modules/analytics.js?v=5.5.19",
  "./modules/bayesian.js?v=5.5.19",
  "./modules/session.js?v=5.5.19",
  "./modules/pressure.js?v=5.5.19",
  "./modules/recommendations.js?v=5.5.19",
  "./modules/render.js?v=5.5.19",
  "./modules/inference.js?v=5.5.19",
  "./manifest.json?v=5.5.19",
  "./icon.svg?v=5.5.19"
];
