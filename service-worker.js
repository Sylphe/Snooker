const CACHE_VERSION = "5.5.10-data-quality-focus-hardening";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.5.10",
  "./styles.css?v=5.5.10",
  "./app.js?v=5.5.10",
  "./modules/app-core.js?v=5.5.10",
  "./modules/version.js?v=5.5.10",
  "./modules/store.js?v=5.5.10",
  "./modules/utils.js?v=5.5.10",
  "./modules/settings.js?v=5.5.10",
  "./modules/analytics.js?v=5.5.10",
  "./modules/bayesian.js?v=5.5.10",
  "./modules/session.js?v=5.5.10",
  "./modules/pressure.js?v=5.5.10",
  "./modules/recommendations.js?v=5.5.10",
  "./modules/render.js?v=5.5.10",
  "./modules/inference.js?v=5.5.10",
  "./manifest.json?v=5.5.10",
  "./icon.svg?v=5.5.10"
];
