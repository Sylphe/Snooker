const CACHE_VERSION = "5.7.44-prediction-engine-tab";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.44",
  "./styles.css?v=5.7.44",
  "./app.js?v=5.7.44",
  "./early-theme.js?v=5.7.44",
  "./modules/app-core.js?v=5.7.44",
  "./modules/version.js?v=5.7.44",
  "./modules/store.js?v=5.7.44",
  "./modules/utils.js?v=5.7.44",
  "./modules/settings.js?v=5.7.44",
  "./modules/analytics.js?v=5.7.44",
  "./modules/bayesian.js?v=5.7.44",
  "./modules/session.js?v=5.7.44",
  "./modules/pressure.js?v=5.7.44",
  "./modules/recommendations.js?v=5.7.44",
  "./modules/render.js?v=5.7.44",
  "./modules/inference.js?v=5.7.44",
  "./manifest.json?v=5.7.44",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.44",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.44",
  "./icon.svg?v=5.7.44"
];
