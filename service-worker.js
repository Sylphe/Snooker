const CACHE_VERSION = "5.7.75B-dependency-chain-engine";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.75B",
  "./styles.css?v=5.7.75B",
  "./app.js?v=5.7.75B",
  "./early-theme.js?v=5.7.75B",
  "./modules/app-core.js?v=5.7.75B",
  "./modules/version.js?v=5.7.75B",
  "./modules/store.js?v=5.7.75B",
  "./modules/utils.js?v=5.7.75B",
  "./modules/settings.js?v=5.7.75B",
  "./modules/analytics.js?v=5.7.75B",
  "./modules/bayesian.js?v=5.7.75B",
  "./modules/session.js?v=5.7.75B",
  "./modules/pressure.js?v=5.7.75B",
  "./modules/recommendations.js?v=5.7.75B",
  "./modules/render.js?v=5.7.75B",
  "./modules/inference.js?v=5.7.75B",
  "./manifest.json?v=5.7.75B",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.75B",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.75B",
  "./icon.svg?v=5.7.75B"
];
