const CACHE_VERSION = "5.7.50-prediction-bootstrap-duplicate-function-fix";
const CACHE_NAME = `snooker-practice-log-${CACHE_VERSION}`;
const ASSETS = [
  "./index.html?v=5.7.50",
  "./styles.css?v=5.7.50",
  "./app.js?v=5.7.50",
  "./early-theme.js?v=5.7.50",
  "./modules/app-core.js?v=5.7.50",
  "./modules/version.js?v=5.7.50",
  "./modules/store.js?v=5.7.50",
  "./modules/utils.js?v=5.7.50",
  "./modules/settings.js?v=5.7.50",
  "./modules/analytics.js?v=5.7.50",
  "./modules/bayesian.js?v=5.7.50",
  "./modules/session.js?v=5.7.50",
  "./modules/pressure.js?v=5.7.50",
  "./modules/recommendations.js?v=5.7.50",
  "./modules/render.js?v=5.7.50",
  "./modules/inference.js?v=5.7.50",
  "./manifest.json?v=5.7.50",
  "./routine-packs/curated-snooker-routine-pack-v1.json?v=5.7.50",
  "./routine-packs/nolan-benchmark-pack-v1.json?v=5.7.50",
  "./icon.svg?v=5.7.50"
];
